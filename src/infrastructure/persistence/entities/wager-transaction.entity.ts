...
export class WagerTransactionEntity {
  ...
  @Property({ fieldName: "wallet_id", type: "uuid", nullable: true })
  walletId?: string;
  @Property({ fieldName: "player_id", length: 128, nullable: true })
  playerId?: string;
  ...
  @Property({ fieldName: "failure_code", nullable: true, length: 64 })
  failureCode?: string;
  @Property({
  ...
  @Property({ fieldName: "reference_attempt_count", default: 0 })
  referenceAttemptCount?: number;
  @Property({ fieldName: "next_reference_attempt_at", nullable: true })
  nextReferenceAttemptAt?: Date;
  @Property({ fieldName: "reference_lease_until", nullable: true })
